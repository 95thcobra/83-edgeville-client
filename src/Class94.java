public class Class94 {
	public static short[] aShortArray707 = new short[] { (short) 6798, (short) 8741, (short) 25238, (short) 4626,
			(short) 4550 };
	public static short[][] aShortArrayArray704 = new short[][] {
			...
			{ (short) 4550, (short) 4537, (short) 5681, (short) 5673, (short) 5790, (short) 6806, (short) 8076,
					(short) 4574, (short) 17050 } };
	public static short[] aShortArray705 = new short[] { (short) -10304, (short) 9104, (short) -1, (short) -1,
			(short) -1 };
	public static short[][] aShortArrayArray706 = new short[][] {
	...
	public static final void method356(final long var0) {
		if (var0 > 0L)
			if (0L == (var0 % 10L)) {
				Class109_Sub10.method535(var0 - 1L);
				Class109_Sub10.method535(1L);
			} else
				Class109_Sub10.method535(var0);
	}
}
